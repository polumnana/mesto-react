        ...
        return (
            <div className="App">
                ...
                <div className="page">
                    ...
                    <Main />
                    <Footer />
                    <PopupWithForm handleFormSubmit="" title="Редактировать профиль" name="edit-profile" isOpened={this.state.isEditProfilePopupOpen}>
                    ...
                    <PopupWithForm handleFormSubmit="" title="Новое место" name="add-photo" isOpened={this.state.isAddPlacePopupOpen}>
                    ...
                    <PopupWithForm handleFormSubmit="" title="Обновить аватар" name="update-avatar" isOpened={this.state.isEditAvatarPopupOpen}>
